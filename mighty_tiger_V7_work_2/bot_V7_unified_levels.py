...
class Bot:
    ...
    def format_top30(self, ex):
        return self.format_top_window(ex, hours=0.5)

    def format_top4h(self, ex):
        return self.format_top_window(ex, hours=4)
    ...
    async def handle(self, ex, symbol, side, usd):
        ...
        if side == "short":
            ...
            self.prune_market_events(ex, now, hours=0.5)
            self.prune_market_events(ex, now, hours=4)
