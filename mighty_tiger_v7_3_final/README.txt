...
- timer marker added near links: <15m => ✅Xm, >=15m => ❌Xm
- compact OI line saves one line in message
- inline buttons added: CG | BY | COPY
- monster reset fix from V7.3 preserved
